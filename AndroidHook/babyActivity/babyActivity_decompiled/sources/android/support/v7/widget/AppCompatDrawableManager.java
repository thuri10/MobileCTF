...
public final class AppCompatDrawableManager {
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor, @Nullable ColorStateList tint) {
        ...
        colors[i] = ColorUtils.compositeColors(colorControlHighlight, tint == null ? baseColor : tint.getColorForState(states[i], 0));
        int i2 = i + 1;
        states[i2] = ThemeUtils.FOCUSED_STATE_SET;
        colors[i2] = ColorUtils.compositeColors(colorControlHighlight, tint == null ? baseColor : tint.getColorForState(states[i2], 0));
        int i3 = i2 + 1;
