...
public final class UnsignedKt {
    ...
    public static final int m479uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m226constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m480uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m226constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m481ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m304constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        return ULong.m304constructorimpl((ulongCompare(ULong.m304constructorimpl(rem), ULong.m304constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m482ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (ulongCompare(ULong.m304constructorimpl(rem), ULong.m304constructorimpl(v2)) >= 0) {
            j = v2;
        }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m226constructorimpl((int) v) : UInt.m226constructorimpl(UInt.m226constructorimpl((int) (v - Integer.MAX_VALUE)) + UInt.m226constructorimpl(Integer.MAX_VALUE));
    }
