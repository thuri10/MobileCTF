...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m304constructorimpl = ((int) ULong.m304constructorimpl(j ^ ULong.m304constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m304constructorimpl2 = (m304constructorimpl + ((int) ULong.m304constructorimpl(j2 ^ ULong.m304constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m304constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            append = sb.append((Object) ULong.m349toStringimpl(this.first)).append("..").append((Object) ULong.m349toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            append = sb.append((Object) ULong.m349toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m349toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1370fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
