...
public final class UStringsKt {
    ...
    public static final String m1436toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1438toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1437toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1435toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m226constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m144boximpl(UByte.m150constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m226constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m226constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m479uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m226constructorimpl(result * uradix);
            result = UInt.m226constructorimpl(UInt.m226constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m220boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m304constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m481ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            long result2 = ULong.m304constructorimpl(result * uradix);
            result = ULong.m304constructorimpl(ULong.m304constructorimpl(UInt.m226constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m298boximpl(result);
    }
}
