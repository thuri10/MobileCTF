...
public interface SendChannel<E> {
    ...
    Object mo1623trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1623trySendJP2dKIU(e);
            if (ChannelResult.m1638isSuccessimpl(result)) {
                return true;
            }
            Throwable m1632exceptionOrNullimpl = ChannelResult.m1632exceptionOrNullimpl(result);
