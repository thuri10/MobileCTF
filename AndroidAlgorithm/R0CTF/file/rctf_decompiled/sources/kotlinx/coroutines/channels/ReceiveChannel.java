...
public interface ReceiveChannel<E> {
    ...
    Object mo1621receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1622tryReceivePtdJZtk = receiveChannel.mo1622tryReceivePtdJZtk();
            if (ChannelResult.m1638isSuccessimpl(mo1622tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1634getOrThrowimpl(mo1622tryReceivePtdJZtk);
            }
            Throwable m1632exceptionOrNullimpl = ChannelResult.m1632exceptionOrNullimpl(mo1622tryReceivePtdJZtk);
            if (m1632exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1632exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1621receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1633getOrNullimpl(r3)
                return r3
            */
