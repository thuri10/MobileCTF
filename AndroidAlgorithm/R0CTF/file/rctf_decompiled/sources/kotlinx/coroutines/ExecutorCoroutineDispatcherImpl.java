...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1669scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        Executor executor = getExecutor();
        ...
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1669scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
