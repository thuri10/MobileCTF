...
final class TimedRunnable implements Comparable<TimedRunnable>, Runnable, ThreadSafeHeapNode {
    ...
    public TimedRunnable(Runnable run, long count, long time) {
        this.run = run;
        this.count = count;
        this.time = time;
    }
    ...
    */
    public /* synthetic */ TimedRunnable(java.lang.Runnable r9, long r10, long r12, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            r8 = this;
            r15 = r14 & 2
            r0 = 0
        ...
        L10:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.test.TimedRunnable.<init>(java.lang.Runnable, long, long, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
