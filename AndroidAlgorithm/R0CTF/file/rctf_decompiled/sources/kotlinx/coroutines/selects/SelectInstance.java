...
public final class SelectInstance<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, kotlinx.coroutines.selects.SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Function0<? extends Object> value, Function0<Unit> block) {
        ...
        while (true) {
            ...
            if (result == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj2, update)) {
                    return;
                }
            } else {
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (result$iv == obj) {
                ...
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _result$FU;
                obj2 = SelectKt.UNDECIDED;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj2, update$iv)) {
                    return;
                }
            } else {
                ...
                if (result$iv == update$iv2) {
                    ...
                    obj3 = SelectKt.RESUMED;
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                        if (Result.m138isFailureimpl(result)) {
                            Continuation $this$resumeWithStackTrace$iv = this.uCont;
                            Throwable exception$iv = Result.m135exceptionOrNullimpl(result);
                            ...
                            $this$resumeWithStackTrace$iv.resumeWith(Result.m132constructorimpl(ResultKt.createFailure(th)));
                            return;
                        }
            ...
            if (result$iv == obj) {
                ...
                if (result$iv == update$iv2) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                        ...
                        Result.Companion companion = Result.INSTANCE;
                        intercepted.resumeWith(Result.m132constructorimpl(ResultKt.createFailure(exception)));
                        return;
                    }
                } else {
                    throw new IllegalStateException("Already resumed");
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m132constructorimpl(ResultKt.createFailure(e)));
