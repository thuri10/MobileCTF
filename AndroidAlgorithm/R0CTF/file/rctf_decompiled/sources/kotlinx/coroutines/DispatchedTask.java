            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        if (DebugKt.getRECOVER_STACK_TRACES()) {
                            try {
                                if (continuation instanceof CoroutineStackFrame) {
                                    ...
                                    continuation.resumeWith(Result.m132constructorimpl(ResultKt.createFailure(cancellationException)));
                                }
                            } catch (Throwable th2) {
                                th = th2;
                        ...
                        continuation.resumeWith(Result.m132constructorimpl(successfulResult$kotlinx_coroutines_core));
                    }
                    ...
                    try {
                        ...
                        result = Result.m132constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.INSTANCE;
                        result = Result.m132constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m135exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
