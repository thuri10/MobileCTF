...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x00c0 A[Catch: all -> 0x00d3, TRY_LEAVE, TryCatch #0 {all -> 0x00d3, blocks: (B:13:0x003d, B:16:0x009e, B:26:0x00ad, B:29:0x00aa, B:18:0x00c0, B:32:0x0052, B:34:0x0066, B:35:0x008e, B:37:0x0077, B:39:0x007b), top: B:7:0x0022 }] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:20:0x00bc -> B:14:0x00bf). Please report as a decompilation issue!!! */
    /*
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        while (i < length) {
            ...
            if (r != null) {
                ...
                r.resumeWith(Result.m132constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    */
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        while (i < length) {
            ...
            if (resume != null) {
                Result.Companion companion = Result.INSTANCE;
                resume.resumeWith(Result.m132constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
