...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    private final void callCancelHandlerSafely(Function0<Unit> block) {
        try {
            ...
            CoroutineExceptionHandlerKt.handleCoroutineException(get$context(), new CompletionHandlerException(Intrinsics.stringPlus("Exception in invokeOnCancellation handler for ", this), ex));
        }
    }
    ...
    private final void callCancelHandler(Function1<? super Throwable, Unit> handler, Throwable cause) {
        try {
            ...
            CoroutineExceptionHandlerKt.handleCoroutineException(get$context(), new CompletionHandlerException(Intrinsics.stringPlus("Exception in invokeOnCancellation handler for ", this), ex$iv));
        }
    }
    ...
    public final void callOnCancellation(Function1<? super Throwable, Unit> onCancellation, Throwable cause) {
        try {
            ...
            CoroutineExceptionHandlerKt.handleCoroutineException(get$context(), new CompletionHandlerException(Intrinsics.stringPlus("Exception in resume onCancellation handler for ", this), ex));
        }
    }
