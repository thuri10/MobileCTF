...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (newInstance != null) {
            m132constructorimpl = Result.m132constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            if (Result.m138isFailureimpl(m132constructorimpl)) {
                m132constructorimpl = null;
            }
            return (Function1) m132constructorimpl;
        }
        ...
        try {
            ...
            if (debugProbesImpl.isInstalled$kotlinx_coroutines_core()) {
                ...
                for (Object element$iv : $this$forEach$iv) {
                    ...
                    List enhancedStackTrace = debugProbesImpl2.enhanceStackTraceWithThreadDumpImpl(info.get_state(), info.lastObservedThread, observedStackTrace);
                    int i3 = i2;
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            m132constructorimpl = Result.m132constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m132constructorimpl = Result.m132constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) m132constructorimpl;
        if (actualTrace == null) {
            return coroutineTrace;
        }
        ...
        try {
            ...
            if (debugProbesImpl.isInstalled$kotlinx_coroutines_core()) {
                ...
                if (cached != null) {
                    ...
                    DebugCoroutineInfo debugCoroutineInfo = owner == null ? null : owner.info;
