        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == r10) {
                if (layoutParams.mFullSpan) {
                    decoratedMeasurement = getMaxEnd(i4);
                } else {
                    decoratedMeasurement = span.getEndLine(i4);
                }
                i2 = this.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement;
                ...
                if (layoutParams.mFullSpan) {
                    startLine = getMinStart(i4);
                } else {
                    startLine = span.getStartLine(i4);
                }
                i2 = startLine;
            ...
            if (isLayoutRTL() && this.mOrientation == r10) {
                ...
                decoratedMeasurement2 = this.mSecondaryOrientation.getDecoratedMeasurement(next) + i7;
                i3 = i7;
            }
            if (this.mOrientation == r10) {
                span2 = span;
                layoutDecoratedWithMargins(next, i3, i5, decoratedMeasurement2, i6);
            } else {
                span2 = span;
                layoutDecoratedWithMargins(next, i5, i3, i6, decoratedMeasurement2);
            }
            if (layoutParams.mFullSpan) {
