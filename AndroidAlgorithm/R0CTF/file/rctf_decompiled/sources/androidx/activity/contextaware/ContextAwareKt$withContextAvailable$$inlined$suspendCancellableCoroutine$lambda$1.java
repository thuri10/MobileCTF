...
public final class ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$1 implements OnContextAvailableListener {
    ...
    public ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$1(CancellableContinuation $captured_local_variable$1, ContextAware contextAware, Function1 function1) {
    ...
    public void onContextAvailable(Context context) {
        ...
        try {
            ...
            m132constructorimpl = Result.m132constructorimpl(this.$onContextAvailable$inlined.invoke(context));
        } catch (Throwable th) {
