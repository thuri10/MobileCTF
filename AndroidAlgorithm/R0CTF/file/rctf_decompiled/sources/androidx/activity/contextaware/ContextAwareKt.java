...
public final class ContextAwareKt {
    public static final <R> Object withContextAvailable(ContextAware $this$withContextAvailable, Function1<? super Context, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$1 listener = new ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$1(co, $this$withContextAvailable, function1);
        $this$withContextAvailable.addOnContextAvailableListener(listener);
        co.invokeOnCancellation(new ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$2(listener, $this$withContextAvailable, function1));
    ...
    private static final Object withContextAvailable$$forInline(ContextAware $this$withContextAvailable, Function1 onContextAvailable, Continuation uCont$iv) {
        ...
        cancellable$iv.initCancellability();
        CancellableContinuationImpl co = cancellable$iv;
        ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$1 listener = new ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$1(co, $this$withContextAvailable, onContextAvailable);
        $this$withContextAvailable.addOnContextAvailableListener(listener);
        co.invokeOnCancellation(new ContextAwareKt$withContextAvailable$$inlined$suspendCancellableCoroutine$lambda$2(listener, $this$withContextAvailable, onContextAvailable));
        Object result = cancellable$iv.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
