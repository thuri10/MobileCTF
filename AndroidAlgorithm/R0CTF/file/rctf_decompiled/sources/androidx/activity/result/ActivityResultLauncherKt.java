...
public final class ActivityResultLauncherKt {
    ...
    public static final void launch(ActivityResultLauncher<Void> launch, ActivityOptionsCompat options) {
        Intrinsics.checkNotNullParameter(launch, "$this$launch");
        launch.launch(null, options);
    }
    ...
    public static final void launchUnit(ActivityResultLauncher<Unit> launch, ActivityOptionsCompat options) {
        Intrinsics.checkNotNullParameter(launch, "$this$launch");
        launch.launch(Unit.INSTANCE, options);
    }
}
