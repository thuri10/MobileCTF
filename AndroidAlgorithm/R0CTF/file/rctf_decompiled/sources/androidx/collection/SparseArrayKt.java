...
public final class SparseArrayKt {
    ...
    public static final <T> boolean contains(SparseArrayCompat<T> receiver$0, int key) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.containsKey(key);
    }

    public static final <T> void set(SparseArrayCompat<T> receiver$0, int key, T t) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        receiver$0.put(key, t);
    }

    public static final <T> SparseArrayCompat<T> plus(SparseArrayCompat<T> receiver$0, SparseArrayCompat<T> other) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(other, "other");
        SparseArrayCompat sparseArrayCompat = new SparseArrayCompat(receiver$0.size() + other.size());
        sparseArrayCompat.putAll(receiver$0);
        sparseArrayCompat.putAll(other);
        return sparseArrayCompat;
    }

    public static final <T> T getOrDefault(SparseArrayCompat<T> receiver$0, int key, T t) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.get(key, t);
    }

    public static final <T> T getOrElse(SparseArrayCompat<T> receiver$0, int key, Function0<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(defaultValue, "defaultValue");
        T t = receiver$0.get(key);
    ...
    public static final <T> boolean remove(SparseArrayCompat<T> receiver$0, int key, T t) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.remove(key, t);
    }
    ...
    public static final <T> void forEach(SparseArrayCompat<T> receiver$0, Function2<? super Integer, ? super T, Unit> action) {
        ...
        for (int index = 0; index < size; index++) {
            action.invoke(Integer.valueOf(receiver$0.keyAt(index)), receiver$0.valueAt(index));
        }
    }
