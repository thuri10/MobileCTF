...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.drawDisappearingViewsFirst = true;
        if (attrs != null) {
            Object name = attrs.getClassAttribute();
            String str = "class";
            ...
            if (name == null) {
                name = $this$_init__u24lambda_u2d0.getString(R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            }
            $this$_init__u24lambda_u2d0.recycle();
            if (name != null && !isInEditMode()) {
                throw new UnsupportedOperationException("FragmentContainerView must be within a FragmentActivity to use " + str + "=\"" + name + Typography.quote);
            }
        }
    }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm) {
        ...
        if (classAttribute != null && existingFragment == null) {
            if (id == -1) {
                String tagMessage = string != null ? Intrinsics.stringPlus(" with tag ", string) : "";
                throw new IllegalStateException("FragmentContainerView must have an android:id to add Fragment " + ((Object) classAttribute) + tagMessage);
            }
        ...
        if (!dispatchInsets.isConsumed()) {
            ...
            if (childCount > 0) {
                do {
                    int i2 = i;
                    i++;
                    ViewCompat.dispatchApplyWindowInsets(getChildAt(i2), dispatchInsets);
                } while (i < childCount);
            }
        }
        return insets;
