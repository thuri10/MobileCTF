...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentActivity$$ExternalSyntheticLambda0
            ...
            public final Bundle saveState() {
                return FragmentActivity.this.m37lambda$init$0$androidxfragmentappFragmentActivity();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.FragmentActivity$$ExternalSyntheticLambda1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                FragmentActivity.this.m38lambda$init$1$androidxfragmentappFragmentActivity(context);
            }
        });
    }

    /* renamed from: lambda$init$0$androidx-fragment-app-FragmentActivity, reason: not valid java name */
    /* synthetic */ Bundle m37lambda$init$0$androidxfragmentappFragmentActivity() {
    ...
    /* synthetic */ void m38lambda$init$1$androidxfragmentappFragmentActivity(Context context) {
