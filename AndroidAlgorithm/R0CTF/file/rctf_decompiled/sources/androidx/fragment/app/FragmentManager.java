...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public final void setFragmentResultListener(final String requestKey, LifecycleOwner lifecycleOwner, final FragmentResultListener listener) {
        ...
        LifecycleEventObserver observer = new LifecycleEventObserver() { // from class: androidx.fragment.app.FragmentManager.5
    ...
    void restoreSaveStateInternal(Parcelable state) {
        ...
        if (fms.mSavedState == null) {
            return;
        }
        this.mFragmentStore.restoreSaveState(fms.mSavedState);
        ...
        if (savedResultKeys != null) {
            for (int i3 = 0; i3 < savedResultKeys.size(); i3++) {
                Bundle savedResult = fms.mResults.get(i3);
                savedResult.setClassLoader(this.mHost.getContext().getClassLoader());
                this.mResults.put(savedResultKeys.get(i3), savedResult);
            }
        }
    ...
    void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer container, final Fragment parent) {
        ...
        if ((obj instanceof SavedStateRegistryOwner) && parent == null) {
            SavedStateRegistry registry = ((SavedStateRegistryOwner) obj).getSavedStateRegistry();
            registry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
        ...
        if (obj2 instanceof ActivityResultRegistryOwner) {
            ActivityResultRegistry registry2 = ((ActivityResultRegistryOwner) obj2).getActivityResultRegistry();
            String parentId = parent != null ? parent.mWho + ":" : "";
            String keyPrefix = "FragmentManager:" + parentId;
            this.mStartActivityForResult = registry2.register(keyPrefix + "StartActivityForResult", new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.7
            ...
            this.mStartIntentSenderForResult = registry2.register(keyPrefix + "StartIntentSenderForResult", new FragmentIntentSenderContract(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.8
                @Override // androidx.activity.result.ActivityResultCallback
                public void onActivityResult(ActivityResult result) {
                    LaunchedFragmentInfo requestInfo = FragmentManager.this.mLaunchedFragments.pollFirst();
                    if (requestInfo == null) {
            ...
            this.mRequestPermissions = registry2.register(keyPrefix + "RequestPermissions", new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() { // from class: androidx.fragment.app.FragmentManager.9
                @Override // androidx.activity.result.ActivityResultCallback
    ...
    /* synthetic */ Bundle m41lambda$attachController$0$androidxfragmentappFragmentManager() {
