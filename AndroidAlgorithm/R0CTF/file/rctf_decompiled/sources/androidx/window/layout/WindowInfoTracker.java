...
public interface WindowInfoTracker {
    ...
    public static final class Companion {
        ...
        public final WindowBackend windowBackend$window_release(Context context) {
            ...
            try {
                WindowLayoutComponent p0 = SafeWindowLayoutComponentProvider.INSTANCE.getWindowLayoutComponent();
                if (p0 != null) {
            ...
            return extensionBackend == null ? SidecarWindowBackend.INSTANCE.getInstance(context) : extensionBackend;
        }
