...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            ...
            public final boolean test(Object obj) {
                boolean m71translateActivityPairPredicates$lambda1;
                m71translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m71translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m71translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public static final boolean m71translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair $dstr$first$second) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m70translateActivityIntentPredicates$lambda3;
                m70translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m70translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m70translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public static final boolean m70translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair $dstr$first$second) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue($dstr$first$second, "(first, second)");
        Activity first = (Activity) this$0.component1($dstr$first$second);
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m74translateParentMetricsPredicate$lambda4;
                m74translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m74translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m74translateParentMetricsPredicate$lambda4;
            }
        };
    }
    ...
    public static final boolean m74translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        Intrinsics.checkNotNullParameter(splitRule, "$splitRule");
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m72translateActivityPredicates$lambda6;
                m72translateActivityPredicates$lambda6 = EmbeddingAdapter.m72translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m72translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public static final boolean m72translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m73translateIntentPredicates$lambda8;
                m73translateIntentPredicates$lambda8 = EmbeddingAdapter.m73translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m73translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    public static final boolean m73translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set $this$any$iv = activityFilters;
        if (($this$any$iv instanceof Collection) && $this$any$iv.isEmpty()) {
            return false;
