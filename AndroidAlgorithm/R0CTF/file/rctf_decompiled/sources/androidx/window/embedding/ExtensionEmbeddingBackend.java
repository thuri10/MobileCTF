...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class Companion {
        ...
        public final ExtensionEmbeddingBackend getInstance() {
            if (ExtensionEmbeddingBackend.globalInstance == null) {
                ...
                try {
                    if (ExtensionEmbeddingBackend.globalInstance == null) {
                        EmbeddingInterfaceCompat embeddingExtension = ExtensionEmbeddingBackend.INSTANCE.initAndVerifyEmbeddingExtension();
    ...
    public static final class SplitListenerWrapper {
        ...
        public final void accept(List<SplitInfo> splitInfoList) {
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.embedding.ExtensionEmbeddingBackend$SplitListenerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ExtensionEmbeddingBackend.SplitListenerWrapper.m75accept$lambda1(ExtensionEmbeddingBackend.SplitListenerWrapper.this, splitsWithActivity);
                }
            });
        }
        ...
        public static final void m75accept$lambda1(SplitListenerWrapper this$0, List splitsWithActivity) {
