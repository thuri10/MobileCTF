...
public final class ViewPager2 extends ViewGroup {
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll) {
        ...
        if (!smoothScroll) {
            ...
            if (Math.abs(item2 - previousItem) > 3.0d) {
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        void updatePageAccessibilityActions() {
            ...
            if (ViewPager2.this.getOrientation() == 0) {
                ...
                int actionIdPageForward = isLayoutRtl ? android.R.id.accessibilityActionPageLeft : android.R.id.accessibilityActionPageRight;
                if (isLayoutRtl) {
                    actionIdPageBackward = android.R.id.accessibilityActionPageRight;
                }
