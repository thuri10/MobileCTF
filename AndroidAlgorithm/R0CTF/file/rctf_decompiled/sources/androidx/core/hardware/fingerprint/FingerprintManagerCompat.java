...
public class FingerprintManagerCompat {
    ...
    public boolean hasEnrolledFingerprints() {
        ...
        return Build.VERSION.SDK_INT >= 23 && (fp = getFingerprintManagerOrNull(this.mContext)) != null && Api23Impl.hasEnrolledFingerprints(fp);
    }

    public boolean isHardwareDetected() {
        FingerprintManager fp;
        return Build.VERSION.SDK_INT >= 23 && (fp = getFingerprintManagerOrNull(this.mContext)) != null && Api23Impl.isHardwareDetected(fp);
    }
