...
public final class NavBackStackEntryState implements Parcelable {
    ...
    public final NavBackStackEntry instantiate(Context context, NavDestination destination, Lifecycle.State hostLifecycleState, NavControllerViewModel viewModel) {
        ...
        Bundle $this$instantiate_u24lambda_u2d0 = this.args;
        if ($this$instantiate_u24lambda_u2d0 == null) {
            $this$instantiate_u24lambda_u2d0 = null;
        } else {
            $this$instantiate_u24lambda_u2d0.setClassLoader(context.getClassLoader());
        }
        Bundle args = $this$instantiate_u24lambda_u2d0;
