...
public final class NavDeepLinkDslBuilder {
    ...
    public final NavDeepLink build$navigation_common_release() {
        NavDeepLink.Builder $this$build_u24lambda_u2d4 = this.builder;
        if (!((getUriPattern() == null && getAction() == null && getMimeType() == null) ? false : true)) {
            throw new IllegalStateException("The NavDeepLink must have an uri, action, and/or mimeType.".toString());
        }
        String it = getUriPattern();
        if (it != null) {
            $this$build_u24lambda_u2d4.setUriPattern(it);
        }
        String it2 = getAction();
        if (it2 != null) {
            $this$build_u24lambda_u2d4.setAction(it2);
        }
        String it3 = getMimeType();
        if (it3 != null) {
            $this$build_u24lambda_u2d4.setMimeType(it3);
        }
        return $this$build_u24lambda_u2d4.build();
    }
}
