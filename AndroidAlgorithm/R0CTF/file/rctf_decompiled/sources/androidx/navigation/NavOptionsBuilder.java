...
public final class NavOptionsBuilder {
    ...
    public final void anim(Function1<? super AnimBuilder, Unit> animBuilder) {
        ...
        AnimBuilder $this$anim_u24lambda_u2d1 = new AnimBuilder();
        animBuilder.invoke($this$anim_u24lambda_u2d1);
        this.builder.setEnterAnim($this$anim_u24lambda_u2d1.getEnter()).setExitAnim($this$anim_u24lambda_u2d1.getExit()).setPopEnterAnim($this$anim_u24lambda_u2d1.getPopEnter()).setPopExitAnim($this$anim_u24lambda_u2d1.getPopExit());
    }

    public final NavOptions build$navigation_common_release() {
        NavOptions.Builder $this$build_u24lambda_u2d2 = this.builder;
        $this$build_u24lambda_u2d2.setLaunchSingleTop(getLaunchSingleTop());
        $this$build_u24lambda_u2d2.setRestoreState(getRestoreState());
        if (getPopUpToRoute() != null) {
            $this$build_u24lambda_u2d2.setPopUpTo(getPopUpToRoute(), this.inclusive, this.saveState);
        } else {
            $this$build_u24lambda_u2d2.setPopUpTo(getPopUpToId(), this.inclusive, this.saveState);
        }
        return $this$build_u24lambda_u2d2.build();
    }
}
