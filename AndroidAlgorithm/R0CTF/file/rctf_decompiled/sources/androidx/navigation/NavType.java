...
public abstract class NavType<T> {
            ...
            if (!(str2 == null || str2.length() == 0)) {
                try {
                    if (StringsKt.startsWith$default(type, ".", false, 2, (Object) null) && packageName != null) {
                        str = Intrinsics.stringPlus(packageName, type);
                    } else {
                        str = type;
                    }
                    ...
                    throw new IllegalArgumentException(Intrinsics.stringPlus(className, " is not Serializable or Parcelable."));
    ...
    public static final class ParcelableArrayType<D extends Parcelable> extends NavType<D[]> {
        ...
        public ParcelableArrayType(Class<D> type) {
            ...
            try {
                Class arrayType = Class.forName("[L" + ((Object) type.getName()) + ';');
                if (arrayType == null) {
