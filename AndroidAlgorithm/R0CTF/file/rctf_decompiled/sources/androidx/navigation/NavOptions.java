...
public final class NavOptions {
    ...
    public boolean equals(Object other) {
        ...
        NavOptions that = (NavOptions) other;
        return this.singleTop == that.singleTop && this.restoreState == that.restoreState && this.popUpToId == that.popUpToId && Intrinsics.areEqual(this.popUpToRoute, that.popUpToRoute) && this.popUpToInclusive == that.popUpToInclusive && this.popUpToSaveState == that.popUpToSaveState && this.enterAnim == that.enterAnim && this.exitAnim == that.exitAnim && this.popEnterAnim == that.popEnterAnim && this.popExitAnim == that.popExitAnim;
    }

    public int hashCode() {
        int i = (((((getSingleTop() ? 1 : 0) * 31) + (getRestoreState() ? 1 : 0)) * 31) + this.popUpToId) * 31;
        String str = this.popUpToRoute;
        return ((((((((((((i + (str == null ? 0 : str.hashCode())) * 31) + (getPopUpToInclusive() ? 1 : 0)) * 31) + (getPopUpToSaveState() ? 1 : 0)) * 31) + this.enterAnim) * 31) + this.exitAnim) * 31) + this.popEnterAnim) * 31) + this.popExitAnim;
    }
