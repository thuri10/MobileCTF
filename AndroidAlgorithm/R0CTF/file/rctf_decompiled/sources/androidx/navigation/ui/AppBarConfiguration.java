...
public final class AppBarConfiguration {
    ...
    private AppBarConfiguration(Set<Integer> set, Openable openableLayout, OnNavigateUpListener fallbackOnNavigateUpListener) {
    ...
    public static final class Builder {
        ...
        public Builder(Menu topLevelMenu) {
            ...
            while (i < size) {
                ...
                this.topLevelDestinations.add(Integer.valueOf(item.getItemId()));
            }
        }
        ...
        public Builder(int... topLevelDestinationIds) {
            ...
            int i = 0;
            while (i < length) {
                int destinationId = topLevelDestinationIds[i];
                i++;
                this.topLevelDestinations.add(Integer.valueOf(destinationId));
            }
        }
