...
public final class BottomNavigationViewKt {
    public static final void setupWithNavController(NavigationBarView $this$setupWithNavController, NavController navController) {
        Intrinsics.checkNotNullParameter($this$setupWithNavController, "<this>");
        Intrinsics.checkNotNullParameter(navController, "navController");
        NavigationUI.setupWithNavController($this$setupWithNavController, navController);
    }
}
