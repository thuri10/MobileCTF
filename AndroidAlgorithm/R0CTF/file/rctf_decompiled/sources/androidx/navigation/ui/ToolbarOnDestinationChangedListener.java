...
public final class ToolbarOnDestinationChangedListener extends AbstractAppBarOnDestinationChangedListener {
    ...
    */
    ...
    protected void setNavigationIcon(Drawable icon, int contentDescription) {
        Toolbar $this$setNavigationIcon_u24lambda_u2d1 = this.toolbarWeakReference.get();
        if ($this$setNavigationIcon_u24lambda_u2d1 != null) {
            boolean useTransition = icon == null && $this$setNavigationIcon_u24lambda_u2d1.getNavigationIcon() != null;
            $this$setNavigationIcon_u24lambda_u2d1.setNavigationIcon(icon);
            $this$setNavigationIcon_u24lambda_u2d1.setNavigationContentDescription(contentDescription);
            if (useTransition) {
                TransitionManager.beginDelayedTransition($this$setNavigationIcon_u24lambda_u2d1);
            }
        }
    }
}
