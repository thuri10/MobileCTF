...
public final class FragmentNavigatorExtrasKt {
    public static final FragmentNavigator.Extras FragmentNavigatorExtras(Pair<? extends View, String>... sharedElements) {
        ...
        FragmentNavigator.Extras.Builder $this$FragmentNavigatorExtras_u24lambda_u2d1 = new FragmentNavigator.Extras.Builder();
        int length = sharedElements.length;
        int i = 0;
        while (i < length) {
            Pair<? extends View, String> pair = sharedElements[i];
            i++;
            View view = pair.component1();
            String name = pair.component2();
            $this$FragmentNavigatorExtras_u24lambda_u2d1.addSharedElement(view, name);
        }
        return $this$FragmentNavigatorExtras_u24lambda_u2d1.build();
    }
}
