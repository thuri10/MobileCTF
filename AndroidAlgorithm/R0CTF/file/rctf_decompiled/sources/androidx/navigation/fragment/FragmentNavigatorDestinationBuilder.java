...
public final class FragmentNavigatorDestinationBuilder extends NavDestinationBuilder<FragmentNavigator.Destination> {
    ...
    public FragmentNavigatorDestinationBuilder(FragmentNavigator navigator, int id, KClass<? extends Fragment> fragmentClass) {
        super(navigator, id);
    ...
    public FragmentNavigator.Destination build() {
        ...
        FragmentNavigator.Destination destination = (FragmentNavigator.Destination) build;
