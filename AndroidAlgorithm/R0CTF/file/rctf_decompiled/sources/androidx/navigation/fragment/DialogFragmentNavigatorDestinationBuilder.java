...
public final class DialogFragmentNavigatorDestinationBuilder extends NavDestinationBuilder<DialogFragmentNavigator.Destination> {
    ...
    public DialogFragmentNavigatorDestinationBuilder(DialogFragmentNavigator navigator, int id, KClass<? extends DialogFragment> fragmentClass) {
        super(navigator, id);
    ...
    public DialogFragmentNavigator.Destination build() {
        ...
        DialogFragmentNavigator.Destination destination = (DialogFragmentNavigator.Destination) build;
