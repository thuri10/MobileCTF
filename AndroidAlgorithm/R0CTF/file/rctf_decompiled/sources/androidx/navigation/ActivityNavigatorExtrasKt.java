...
public final class ActivityNavigatorExtrasKt {
    ...
    public static final ActivityNavigator.Extras ActivityNavigatorExtras(ActivityOptionsCompat activityOptions, int flags) {
        ActivityNavigator.Extras.Builder $this$ActivityNavigatorExtras_u24lambda_u2d0 = new ActivityNavigator.Extras.Builder();
        if (activityOptions != null) {
            $this$ActivityNavigatorExtras_u24lambda_u2d0.setActivityOptions(activityOptions);
        }
        $this$ActivityNavigatorExtras_u24lambda_u2d0.addFlags(flags);
        return $this$ActivityNavigatorExtras_u24lambda_u2d0.build();
    }
}
