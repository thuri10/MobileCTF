...
public final class NavArgument {
    ...
    public NavArgument(NavType<Object> type, boolean isNullable, Object defaultValue, boolean defaultValuePresent) {
        Intrinsics.checkNotNullParameter(type, "type");
        if (!(type.getIsNullableAllowed() || !isNullable)) {
            throw new IllegalArgumentException(Intrinsics.stringPlus(type.getName(), " does not allow nullable values").toString());
        }
    ...
    public boolean equals(Object other) {
        ...
        if (obj != null) {
            return Intrinsics.areEqual(obj, that.defaultValue);
        }
    ...
    public static final class Builder {
        ...
        public final NavArgument build() {
            NavType finalType = this.type;
            if (finalType == null) {
                finalType = NavType.INSTANCE.inferFromValueType(this.defaultValue);
            }
