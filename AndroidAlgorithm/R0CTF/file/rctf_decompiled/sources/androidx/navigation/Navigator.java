...
public abstract class Navigator<D extends NavDestination> {
    ...
    public void navigate(List<NavBackStackEntry> entries, final NavOptions navOptions, final Extras navigatorExtras) {
        ...
        Sequence $this$forEach$iv = SequencesKt.filterNotNull(SequencesKt.map(CollectionsKt.asSequence(entries), new Function1<NavBackStackEntry, NavBackStackEntry>(this) { // from class: androidx.navigation.Navigator$navigate$1
            ...
            public final NavBackStackEntry invoke(NavBackStackEntry backStackEntry) {
                ...
                if (destination == null || (navigatedToDestination = this.this$0.navigate(destination, backStackEntry.getArguments(), navOptions, navigatorExtras)) == null) {
                    return null;
                }
                return Intrinsics.areEqual(navigatedToDestination, destination) ? backStackEntry : this.this$0.getState().createBackStackEntry(navigatedToDestination, navigatedToDestination.addInDefaultArgs(backStackEntry.getArguments()));
            }
        }));
