...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public ActivityNavigator(Context context) {
        ...
        Sequence $this$firstOrNull$iv = SequencesKt.generateSequence(context, new Function1<Context, Context>() { // from class: androidx.navigation.ActivityNavigator$hostActivity$1
    ...
    public NavDestination navigate(Destination destination, Bundle args, NavOptions navOptions, Navigator.Extras navigatorExtras) {
            ...
            if (!(str == null || str.length() == 0)) {
                ...
                while (matcher.find()) {
                    ...
                    if (!args.containsKey(argName)) {
                        throw new IllegalArgumentException("Could not find " + ((Object) argName) + " in " + args + " to fill data pattern " + ((Object) dataPattern));
                    }
        ...
        if (navOptions != null) {
            ...
            if ((popEnterAnim <= 0 || !Intrinsics.areEqual(resources.getResourceTypeName(popEnterAnim), "animator")) && (popExitAnim <= 0 || !Intrinsics.areEqual(resources.getResourceTypeName(popExitAnim), "animator"))) {
                ...
                Log.w(LOG_TAG, "Activity destinations do not support Animator resource. Ignoring popEnter resource " + ((Object) resources.getResourceName(popEnterAnim)) + " and popExit resource " + ((Object) resources.getResourceName(popExitAnim)) + " when launching " + destination);
            }
        }
        if (navigatorExtras instanceof Extras) {
        ...
        if ((enterAnim > 0 && Intrinsics.areEqual(resources.getResourceTypeName(enterAnim), "animator")) || (exitAnim > 0 && Intrinsics.areEqual(resources.getResourceTypeName(exitAnim), "animator"))) {
            Log.w(LOG_TAG, "Activity destinations do not support Animator resource. Ignoring enter resource " + ((Object) resources.getResourceName(enterAnim)) + " and exit resource " + ((Object) resources.getResourceName(exitAnim)) + "when launching " + destination);
            return null;
        }
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attrs) {
            ...
            String targetPackage = $this$use$iv.getString(R.styleable.ActivityNavigator_targetPackage);
            if (targetPackage != null) {
                String packageName = context.getPackageName();
                Intrinsics.checkNotNullExpressionValue(packageName, "context.packageName");
                targetPackage = StringsKt.replace$default(targetPackage, NavInflater.APPLICATION_ID_PLACEHOLDER, packageName, false, 4, (Object) null);
            }
            setTargetPackage(targetPackage);
            String className = $this$use$iv.getString(R.styleable.ActivityNavigator_android_name);
            if (className != null) {
                if (className.charAt(0) == '.') {
                    className = Intrinsics.stringPlus(context.getPackageName(), className);
                }
                setComponentName(new ComponentName(context, className));
            }
            setAction($this$use$iv.getString(R.styleable.ActivityNavigator_action));
            String data = $this$use$iv.getString(R.styleable.ActivityNavigator_data);
            if (data != null) {
                setData(Uri.parse(data));
            }
            setDataPattern($this$use$iv.getString(R.styleable.ActivityNavigator_dataPattern));
            $this$use$iv.recycle();
        }
        ...
        public boolean equals(Object other) {
            ...
            Intent intent = this.intent;
            Boolean valueOf = intent == null ? null : Boolean.valueOf(intent.filterEquals(((Destination) other).intent));
            return (valueOf == null ? ((Destination) other).intent == null : valueOf.booleanValue()) && Intrinsics.areEqual(this.dataPattern, ((Destination) other).dataPattern);
        }
        ...
        public int hashCode() {
            ...
            int i = result * 31;
            Intent intent = this.intent;
            int result2 = i + (intent == null ? 0 : intent.filterHashCode());
