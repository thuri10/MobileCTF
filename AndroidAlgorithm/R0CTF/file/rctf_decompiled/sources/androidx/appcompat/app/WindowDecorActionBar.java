...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(androidx.appcompat.R.id.decor_content_parent);
        ...
        ActionBarContainer actionBarContainer = (ActionBarContainer) decor.findViewById(androidx.appcompat.R.id.action_bar_container);
