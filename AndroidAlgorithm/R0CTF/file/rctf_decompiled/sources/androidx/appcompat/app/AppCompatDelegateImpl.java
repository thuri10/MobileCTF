...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context baseContext) {
        ...
        if (sCanApplyOverrideConfiguration && (baseContext instanceof ContextThemeWrapper)) {
            Configuration config = createOverrideConfigurationForDayNight(baseContext, modeToApply, null, false);
            try {
        ...
        if (baseContext instanceof androidx.appcompat.view.ContextThemeWrapper) {
            Configuration config2 = createOverrideConfigurationForDayNight(baseContext, modeToApply, null, false);
            try {
        ...
        Configuration config3 = createOverrideConfigurationForDayNight(baseContext, modeToApply, configOverlay, true);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                DecorContentParent decorContentParent = (DecorContentParent) subDecor.findViewById(androidx.appcompat.R.id.decor_content_parent);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(actionBarContext, (AttributeSet) null, androidx.appcompat.R.attr.actionModePopupWindowStyle);
    ...
    */
    ...
    public View createView(View view, String name, Context context, AttributeSet attrs) {
        ...
        return this.mAppCompatViewInflater.createView(view, name, context, attrs, inheritContext, z2, true, VectorEnabledTintResources.shouldBeUsed());
    }
    ...
    */
    ...
    private boolean updateForNightMode(int mode, boolean allowRecreation) {
        boolean handled = false;
        Configuration overrideConfig = createOverrideConfigurationForDayNight(this.mContext, mode, null, false);
        boolean activityHandlingUiMode = isActivityManifestHandlingUiMode(this.mContext);
