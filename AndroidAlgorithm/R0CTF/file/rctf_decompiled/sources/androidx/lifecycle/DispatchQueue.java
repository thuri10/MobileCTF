...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(final CoroutineContext context, final Runnable runnable) {
        ...
        MainCoroutineDispatcher $this$with = Dispatchers.getMain().getImmediate();
        if ($this$with.isDispatchNeeded(context) || canRun()) {
            $this$with.mo1668dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$dispatchAndEnqueue$$inlined$with$lambda$1
