...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float startCenterX = startTimePoint.x + (f2 / 2.0f);
        float startCenterY = startTimePoint.y + (f4 / 2.0f);
        ...
        this.x = (int) ((r15 + (pathVectorX * position)) - ((scaleX * scaleWidth) / 2.0f));
        this.y = (int) ((r3 + (pathVectorY * position)) - ((scaleY * scaleHeight) / 2.0f));
    ...
    void initPolar(int parentWidth, int parentHeight, KeyPosition c, MotionPaths s, MotionPaths e) {
        ...
        this.position = this.time;
        this.width = (int) (r4 + (scaleX * scaleWidth));
        this.height = (int) (r6 + (scaleY * scaleHeight));
        float f2 = 1.0f - position;
        switch (c.mPositionType) {
            case 1:
                float f3 = Float.isNaN(c.mPercentX) ? position : c.mPercentX;
                float f4 = e.x;
                float f5 = s.x;
                this.x = (f3 * (f4 - f5)) + f5;
                float f6 = Float.isNaN(c.mPercentY) ? position : c.mPercentY;
                float f7 = e.y;
                float f8 = s.y;
                this.y = (f6 * (f7 - f8)) + f8;
                break;
            case 2:
                ...
                break;
            default:
                float f13 = Float.isNaN(c.mPercentX) ? position : c.mPercentX;
                float f14 = e.x;
                float f15 = s.x;
                this.x = (f13 * (f14 - f15)) + f15;
                float f16 = Float.isNaN(c.mPercentY) ? position : c.mPercentY;
                float f17 = e.y;
                float f18 = s.y;
                this.y = (f16 * (f17 - f18)) + f18;
                break;
        }
    ...
    void initScreen(int parentWidth, int parentHeight, KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float pathVectorY = endCenterY - startCenterY;
        this.x = (int) ((r15 + (pathVectorX * position)) - ((scaleX * scaleWidth) / 2.0f));
        this.y = (int) ((r4 + (pathVectorY * position)) - ((scaleY * scaleHeight) / 2.0f));
        this.width = (int) (f2 + (scaleX * scaleWidth));
        this.height = (int) (f4 + (scaleY * scaleHeight));
        this.mMode = 2;
        if (!Float.isNaN(c.mPercentX)) {
    ...
    void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float pathVectorX = endCenterX - startCenterX;
        float pathVectorY = endCenterY - startCenterY;
        this.x = (int) ((r11 + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f));
        this.y = (int) ((r15 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f));
        this.width = (int) (r12 + (scaleX * scaleWidth));
        this.height = (int) (r4 + (scaleY * scaleHeight));
        ...
        this.x = f;
        float f2 = (int) ((startTimePoint.y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f));
        this.y = f2;
        this.x = f + normalX;
        this.y = f2 + normalY;
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
