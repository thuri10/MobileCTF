...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_item_01) {
            Intent intent = new Intent(this, (Class<?>) Item01Activity.class);
            startActivity(intent);
        } else if (view.getId() == R.id.btn_item_02) {
            Intent intent2 = new Intent(this, (Class<?>) Itme02Activity.class);
            startActivity(intent2);
        } else if (view.getId() == R.id.btn_item_03) {
            Intent intent3 = new Intent(this, (Class<?>) Itme03Activity.class);
