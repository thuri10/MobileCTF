...
public final class TemperatureCache {
    ...
    public List<Hct> getAnalogousColors(int count, int divisions) {
        ...
        Hct hct = getHctsByHue().get(startHue);
        double lastTemp = getRelativeTemperature(hct);
        ...
        double lastTemp2 = getRelativeTemperature(hct);
        while (true) {
            Hct startHct = hct;
            ...
            Hct hct2 = getHctsByHue().get(hue2);
            double temp2 = getRelativeTemperature(hct2);
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Comparator<Hct> temperaturesComparator = Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.TemperatureCache$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return TemperatureCache.this.m87xb7a75f35((Hct) obj);
            }
    ...
    /* synthetic */ Double m87xb7a75f35(Hct arg) {
