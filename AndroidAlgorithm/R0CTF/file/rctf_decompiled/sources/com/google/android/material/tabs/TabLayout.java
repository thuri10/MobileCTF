    ...
    public final class TabView extends LinearLayout {
        ...
        final void updateTab() {
            ...
            if (custom != null) {
                ...
                TextView textView2 = (TextView) custom.findViewById(android.R.id.text1);
        ...
        private void inflateAndAddDefaultIconView() {
            FrameLayout iconViewParent = this;
            if (BadgeUtils.USE_COMPAT_PARENT) {
                iconViewParent = createPreApi18BadgeAnchorRoot();
                addView(iconViewParent, 0);
            }
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.design_layout_tab_icon, (ViewGroup) iconViewParent, false);
            this.iconView = imageView;
            iconViewParent.addView(imageView, 0);
        }

        private void inflateAndAddDefaultTextView() {
            FrameLayout textViewParent = this;
            if (BadgeUtils.USE_COMPAT_PARENT) {
                textViewParent = createPreApi18BadgeAnchorRoot();
                addView(textViewParent);
            }
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.design_layout_tab_text, (ViewGroup) textViewParent, false);
