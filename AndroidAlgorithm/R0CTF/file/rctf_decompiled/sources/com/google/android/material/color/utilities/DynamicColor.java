...
public final class DynamicColor {
    ...
    public double getTone(final DynamicScheme scheme) {
        ...
        if (scheme.contrastLevel == 0.0d) {
            ...
            double endTone = (decreasingContrast ? this.toneMinContrast : this.toneMaxContrast).apply(scheme).doubleValue();
            double delta2 = (endTone - startTone) * Math.abs(scheme.contrastLevel);
            double answer2 = delta2 + startTone;
            delta = answer2;
        }
        Function<DynamicScheme, DynamicColor> function = this.background;
        final DynamicColor bgDynamicColor = function == null ? null : function.apply(scheme);
        if (bgDynamicColor == null) {
            maxRatio = 21.0d;
            minRatio = 1.0d;
        } else {
            Function<DynamicScheme, DynamicColor> function2 = bgDynamicColor.background;
            boolean bgHasBg = (function2 == null || function2.apply(scheme) == null) ? false : true;
        ...
        final double finalAnswer = delta;
