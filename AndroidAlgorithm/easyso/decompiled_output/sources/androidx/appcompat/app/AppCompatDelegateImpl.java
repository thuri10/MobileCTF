...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private AppCompatDelegateImpl(Context context, Window window, AppCompatCallback callback, Object host) {
        ...
        if (this.mLocalNightMode == -100 && (value = (map = sLocalNightModes).get(host.getClass())) != null) {
            this.mLocalNightMode = value.intValue();
            map.remove(host.getClass());
        }
        if (window != null) {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            ...
            if (this.mOverlayActionMode) {
                subDecor = (ViewGroup) inflater.inflate(androidx.appcompat.R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                subDecor = (ViewGroup) inflater.inflate(androidx.appcompat.R.layout.abc_screen_simple, (ViewGroup) null);
            }
