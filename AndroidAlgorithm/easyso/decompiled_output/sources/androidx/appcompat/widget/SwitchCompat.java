...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTextOn = a.getText(androidx.appcompat.R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a.getText(androidx.appcompat.R.styleable.SwitchCompat_android_textOff);
