...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
        ...
        synchronized (this) {
            ...
            if (arrayList3 != null && (N2 = arrayList3.size()) > 0) {
                ...
                for (int i4 = 0; i4 < N2; i4++) {
                    BackStackRecord bs2 = this.mBackStackIndices.get(i4);
                    writer.print(prefix);
                    writer.print("  #");
                    writer.print(i4);
                    writer.print(": ");
    ...
    */
    ...
    public void attachController(FragmentHostCallback fragmentHostCallback, FragmentContainer container, Fragment parent) {
        if (this.mHost != null) {
