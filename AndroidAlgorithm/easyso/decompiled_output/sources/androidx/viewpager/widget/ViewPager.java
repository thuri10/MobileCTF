...
public class ViewPager extends ViewGroup {
        ...
        while (true) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    child.layout(childLeft2, childTop, measuredWidth, paddingTop3);
                    decorCount++;
    ...
    private boolean performDrag(float x) {
        ...
        ItemInfo lastItem = this.mItems.get(r12.size() - 1);
    ...
    private int determineTargetPage(int currentPage, float pageOffset, int velocity, int deltaX) {
        ...
        if (this.mItems.size() > 0) {
            ItemInfo firstItem = this.mItems.get(0);
            ItemInfo lastItem = this.mItems.get(r2.size() - 1);
    ...
    public void fakeDragBy(float xOffset) {
        ...
        if (this.mAdapter != null) {
            ...
            float rightBound = width * this.mLastOffset;
            ItemInfo firstItem = this.mItems.get(0);
            ItemInfo lastItem = this.mItems.get(r7.size() - 1);
            if (firstItem.position != 0) {
                leftBound = firstItem.offset * width;
            }
            if (lastItem.position != this.mAdapter.getCount() - 1) {
