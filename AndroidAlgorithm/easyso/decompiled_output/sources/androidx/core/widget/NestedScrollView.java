                    ...
                    if (activePointerIndex == -1) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            if (canOverscroll) {
                                ...
                                if (pulledToY < 0) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowTop, deltaY3 / getHeight(), ev.getX(activePointerIndex) / getWidth());
                                    if (!this.mEdgeGlowBottom.isFinished()) {
                                        this.mEdgeGlowBottom.onRelease();
                                    }
                                } else if (pulledToY > range) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, deltaY3 / getHeight(), 1.0f - (ev.getX(activePointerIndex) / getWidth()));
