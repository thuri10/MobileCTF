...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attrs) {
        ...
        this.inactiveItemMaxWidth = res.getDimensionPixelSize(com.google.android.material.R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = res.getDimensionPixelSize(com.google.android.material.R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = res.getDimensionPixelSize(com.google.android.material.R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = res.getDimensionPixelSize(com.google.android.material.R.dimen.design_bottom_navigation_active_item_min_width);
        this.itemHeight = res.getDimensionPixelSize(com.google.android.material.R.dimen.design_bottom_navigation_height);
        ...
        if (isShifting(this.labelVisibilityMode, visibleCount) && this.itemHorizontalTranslationEnabled) {
            ...
            while (i2 < totalCount) {
                if (getChildAt(i2).getVisibility() != i) {
                    ...
                    iArr[i2] = i2 == this.selectedItemPosition ? activeWidth : inactiveWidth;
                    if (extra > 0) {
                        iArr[i2] = iArr[i2] + 1;
                        extra--;
                    }
